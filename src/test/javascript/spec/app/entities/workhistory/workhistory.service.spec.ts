...
describe('Service Tests', () => {
    ...
    describe('Workhistory Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(WorkhistoryService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/workhistories/' + 123);
            });
            it('should return Workhistory', () => {

                let entity: Workhistory;
                service.find(123).subscribe((_entity: Workhistory) => {
                    entity = _entity;
                });
